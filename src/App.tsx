...
function App() {
  ...
  const handleSpace = (e: any) => {
    if (e.key === "." || e.key === "Enter") {
      let prevRant = rant.split(" ");
      let randomIndex = Math.floor(Math.random() * prevRant.length);
      prevRant.splice(randomIndex, words.split(" ").length, words);
      let newRant = prevRant.join(" ");
  ...
  return (
    ...
    >
      ...
      tap the flower for every time it helps <CiHeart />
      </p>
    </div>
  );
}
